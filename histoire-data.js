const HISTOIRES = [
  ...
  },
  {
    ...
    styleNum: 1,
    paragraphs: [
      "Le minimalisme trouve ses origines dans plusieurs courants artistiques du XXe siècle, notamment le Bauhaus et le design japonais. Son principe est simple : retirer tout ce qui est inutile afin de ne conserver que l'essentiel.",
  ...
  },
  {
    ...
    styleNum: 17,
    paragraphs: [
      "Le collage apparaît au début du XXe siècle avec les artistes cubistes comme Pablo Picasso et Georges Braque. Ils commencent à intégrer des morceaux de journaux, de papiers et de tissus directement dans leurs œuvres.",
  ...
  },
  {
    ...
    styleNum: 11,
    paragraphs: [
      "Le style cartoon est directement issu de l'animation américaine du début du XXe siècle. Des studios comme Disney, Warner Bros. et Hanna-Barbera développent des personnages aux formes simples, aux expressions exagérées et aux couleurs vives.",
  ...
  },
  {
    ...
    styleNum: 12,
    paragraphs: [
      "La bande dessinée moderne se développe au cours du XXe siècle, notamment en Belgique, en France et aux États-Unis. Les cases, les bulles, les onomatopées et les contours noirs deviennent rapidement des codes universels.",
  ...
  },
  {
    id: "aquarelle",
    title: "L'Aquarelle",
    era: "Depuis le XVIIIe siècle",
    styleNum: 15,
    paragraphs: [
      "L'aquarelle est une technique de peinture utilisée depuis plusieurs siècles. Très populaire à partir du XVIIIe siècle, elle permet de créer des œuvres légères, transparentes et lumineuses.",
